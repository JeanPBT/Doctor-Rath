        ...
        <div class="ttm-row sidebar ttm-sidebar-right ttm-bgcolor-white clearfix">
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="ttm-blog-classic-content">
                                ...
                                <div class="ttm-post-entry-header">
                                    <div class="post-meta">
                                        ...
                                        <span class="ttm-meta-line entry-date"><i class="fa fa-calendar"></i><time class="entry-date published" >{{ date("D, d M Y", strtotime($dataRows[0]->created_at)) }}</time></span>
                                    </div>
                    ...
                    <?php  
                                    $dataRows = DB::select(" SELECT  COUNT(id) as id, DATE_FORMAT(created_at, '%Y %M ') as created_at FROM web_blog GROUP BY DATE_FORMAT(created_at, '%Y %M ') desc");
                            ?>
